...
<title>Staff Dashboard | E-Canteen AEC</title>
</head>
<body>
<%
	String cid = "", pass = "";
...
%>
	<header class="header" id="header">
		<nav class="nav container">
			<a href="#" class="nav__logo"><span>E</span>-Canteen</a>
			<div class="nav__menu" id="nav-menu">
				<ul class="nav__list">
					<li class="nav__item">
						<a href="staffDashboard.jsp" class="nav__link active">Home</a>
					</li>
					<li class="nav__item">
						<a href="#" class="nav__link">About Us</a>
					</li>
					<li class="nav__item">
						<a href="editMenu.jsp" class="nav__link">Today's Menu</a>
					</li>
					<li class="nav__item">
